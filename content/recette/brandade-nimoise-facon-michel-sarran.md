---
author: "Paul"
title: "Brandade Nîmoise, façon Michel Sarran"
titleshort: "Brandade Nîmoise"
date: 2026-05-17T18:08:10+02:00
draft: false

description: >
    Une brandade nîmoise (sans pommes de terre), onctueuse et parfumée.<br>
    Accompagnée d'arlettes au parmesan... ou autres fragrances.<br>
    Un plat qui ravira tous les convives, en toutes saisons.

short: >
    Une brandade nîmoise, onctueuse et parfumée
keywords: ""
...
remarque: >
    En fonction des quantités, peut être servi en entrée ou en plat principal<br>
    Avec 180 g de cabillaud par personne, on est dans une version plat<br>
    Recette pour 4 personnes<br>
    Une partie de la recette peut (et même doit) se préparer la veille<br>
    Brander vient de l'occitan et veut dire : remuer !
...
### Pour les arlettes
- 250 g de pâte feuilletée environ
- Parmesan râpé
- Autres ingrédients selon le parfum choisi
## Préparation
### La crème parfumée à l'ail
#### La veille
- ***À préparer la veille***
- Effeuiller un peu de thym pour n'en garder que les feuilles et les fleurs tendres
- Écraser du plat de la main quelques gousses d'ail
- Dans une casserole, verser la crème liquide
- Y jeter les gousses d'ail et les feuilles et fleurs de thym
- Chauffer doucement et laisser infuser jusqu'à ce que les gousses d'ail soient tendres et confites
...
- Ajouter des gousses d'ail, des grains de poivre et des feuilles et fleurs de thym
- Porter doucement à frémissement et arrêter alors la cuisson
...
- Brander toujours en douceur !
- Ajouter les olives de Lucques coupées
...
### Les arlettes
#### La veille
- Préparer la pâte feuilletée en suivant la recette de la [pâte feuilletée de Felder]({{<ref "/recette/pate-feuilletee-rapide-de-felder" >}}) en diminuant les quantités par deux, de manière à avoir environ 250 g de pâte
- Râper le parmesan
- En fonction des parfums choisis, préparer d'autres condiments : par exemple purée d'olives noires et de tomates séchées
- Étaler la pâte feuilletée en lui laissant une bonne épaisseur
- La rouler sur elle-même et la débiter en petits tronçons
- Plonger chaque tronçon dans le parfum choisi et bien l'enrober avec
- Étaler la pâte progressivement tout en ajoutant du parfum régulièrement pour bien en imbiber la pâte feuilletée
- Abaisser finement
- Réserver les abaisses au frais entre deux feuilles de papier cuisson
#### Finalisation & Cuisson
- Préchauffer le four à 180°
- Découper les abaisses à la taille voulue pour la présentation finale
- Disposer les arlettes sur une plaque de four recouverte de papier cuisson
- Recouvrir de papier cuisson
- Déposer une deuxième plaque
- *La cuisson se fait entre deux plaques pour éviter que la pâte feuilletée ne monte trop*
- Cuire 6 minutes pour des arlettes au paremsan
- ***Pour des arlettes avec d'autres parfums, la cuisson peut être nettement plus longue : surveiller la coloration***
### Service
